...
with open('valid_clean.jsonl', 'r', encoding='utf-8') as jsonl_file:  # Specify encoding as utf-8
    # Open CSV file for writing
    with open('Java_valid.csv', 'w', newline='', encoding='utf-8') as csvfile:  # Specify encoding as utf-8
